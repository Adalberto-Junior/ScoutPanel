        ...
        <div style="height: 100%" class="shadow-none p-3 bg-light rounded">
            <div style="height: 100%; overflow: auto">
                ...
                <div class="p-3 mt-3 bg-body rounded" style="width: 100%">
                    <img src="https://cdn4.iconfinder.com/data/icons/small-n-flat/24/user-alt-512.png" style="width: 50px; heigth: 50px" class="m-3" alt="user">
                    ...
                    <img src="https://i.kym-cdn.com/entries/icons/original/000/039/761/nerdfacecover.jpg" style="width: 100%" alt="nerd">
                </div>
                {/each}
            </div>
        </div>
        ...
        <div style="height: 100%" class="shadow-none p-3 bg-light rounded">
            <div style="height: 50%; overflow: auto">
                <div class="mb-1 bg-body rounded" style="width: 100%">
                    <img src="https://cdn4.iconfinder.com/data/icons/small-n-flat/24/user-alt-512.png" style="width: 20px; heigth: 20px" class="m-3" alt="user">
