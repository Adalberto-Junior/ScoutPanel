      ...
      <div class="modal-header">
        ...
        >
          <input
            ...
            checked
          />
          <label class="btn btn-outline-primary" for="btnradio1">Texto</label>
          ...
          <input
            ...
            autocomplete="off"
          />
          <label class="btn btn-outline-primary" for="btnradio2">Media</label>
          ...
          <input
            ...
            autocomplete="off"
          />
          <label class="btn btn-outline-primary" for="btnradio3">Votação</label>
        </div>
        <button
          type="button"
          class="btn-close"
